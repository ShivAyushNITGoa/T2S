    ...
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden font-sans selection:bg-amber-500 selection:text-black">
      ...
      <div className="sticky top-0 z-50 bg-black/90 backdrop-blur-md border-b border-zinc-800 py-3 md:py-4 px-4 md:px-12 flex justify-between items-center transition-all">
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <img 
            src="/logo.png" 
            className="w-8 h-8 sm:w-10 sm:h-10 object-cover rounded-full border border-zinc-800 shadow-[0_0_20px_rgba(245,158,11,0.25)]" 
            alt="Talk2Society Logo" 
            referrerPolicy="no-referrer"
          />
          <div>
            <span className="font-display font-black text-xs sm:text-sm tracking-tight text-white uppercase block leading-none">Talk2Society</span>
            <span className="hidden sm:block text-[10px] font-mono text-amber-400 font-black uppercase tracking-widest mt-1">Sovereign Intel Gate</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          {onEnterWithTab && (
            <button
              ...
              className="px-2.5 sm:px-4 py-1.5 sm:py-2 bg-amber-500/10 hover:bg-amber-500 text-amber-300 hover:text-black border border-amber-500/30 text-[9px] sm:text-[10px] font-mono font-black uppercase tracking-widest rounded-lg transition-all flex items-center gap-1 sm:gap-1.5 cursor-pointer shadow-md shrink-0"
            >
              <ShoppingCart className="w-3.5 h-3.5" /> 
              <span>
                <span className="hidden sm:inline">STRATEGIC </span>SHOP
                <span className="hidden sm:inline"> / स्टोर</span>
              </span>
            </button>
          )}
          ...
          {isAuthenticated ? (
            <button 
              ...
              className="hidden lg:flex items-center gap-2 px-3 py-1 bg-zinc-900 hover:bg-red-950/40 border border-zinc-700 hover:border-red-500/30 rounded-full transition-all cursor-pointer group shrink-0"
            >
            ...
            <button 
              ...
              className="hidden lg:inline-block text-[10px] bg-zinc-900 border border-zinc-700 px-3 py-1 rounded-full font-mono text-zinc-400 hover:text-amber-400 hover:border-amber-500/30 uppercase tracking-widest font-black transition-all cursor-pointer shrink-0"
            >
          ...
          <button 
            ...
            className="px-2.5 sm:px-4 py-1.5 sm:py-2 bg-white hover:bg-zinc-200 text-black text-[9px] sm:text-[10px] font-mono font-black uppercase tracking-widest rounded-lg transition-all flex items-center gap-1 sm:gap-1.5 hover:scale-[1.02] shadow-md cursor-pointer shrink-0"
          >
            {isAuthenticated ? (
              <>
                <span>Enter<span className="hidden sm:inline"> Portal</span></span> 
